    ...
    <div className="h-screen flex justify-center ">
      ...
      >
        <div className="w-full mx-auto px-20 flex-col items-center space-y-6">
          <h1 className="text-[#f7941e] font-bold text-4xl font-sans">Travel App</h1>
        ...
        <div className="w-full px-8 md:px-32 lg:px-24">
          ...
          >
            ...
            <div>
              <button
                type="submit"
                className="block w-full hover:bg-[#f7941e] mt-5 py-2 rounded-2xl bg-[#0072bc] hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2"
              >
                Đăng ký
              </button>
            </div>
